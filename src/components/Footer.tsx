            ...
            <div className="mt-8">
              <div className="flex items-center space-x-2">
                ...
                <Button 
                  ...
                  size="icon" 
                  onClick={toggleTheme}
                  className="rounded-full w-10 h-10 bg-muted/50 border border-border/50 hover:bg-accent"
                >
                  {theme === 'dark' ? 
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="start" className="w-40 bg-popover border border-border z-50">
                    ...
                    <DropdownMenuItem onClick={() => setLanguage('fa')} className={`cursor-pointer ${language === 'fa' ? 'bg-primary/10 text-primary' : ''}`}>
                      فارسی
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => setLanguage('ar')} className={`cursor-pointer ${language === 'ar' ? 'bg-primary/10 text-primary' : ''}`}>
                      العربية
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => setLanguage('tr')} className={`cursor-pointer ${language === 'tr' ? 'bg-primary/10 text-primary' : ''}`}>
                      Türkçe
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
